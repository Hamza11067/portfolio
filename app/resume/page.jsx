    ...
    >
      <div className="container mx-auto ">
        <Tabs
          ...
          className="flex flex-col xl:flex-row items-start gap-15"
        >
          ...
          <div className="min-h-[70vh] ">
                    ...
                    {experience.items.map((item, index) => {
                      return (
                        ...
                        >
                          ...
                          <h3 className="text-xl max-w-65 max-h-15 text-center lg:text-left">
                            {item.position}
                          </h3>
            ...
            {/* about */}
            <TabsContent value="about" className="w-full min-h-120 text-center xl:text-left">
              <div className="flex flex-col gap-7.5">
